# Examples of Reading and Writing Using Kafka API

This article provides examples of reading and writing to [topics](../../concepts/topic.md) using the Kafka API.

Before running the examples:

1. [Create a topic](../ydb-cli/topic-create.md).
1. [Add a consumer](../ydb-cli/topic-consumer-add.md).
1. [Create a user](../../security/access-management.md#users).

The examples use:

* `<ydb-endpoint>` - {{ ydb-short-name }} endpoint.
...
* `<consumer-name>` - [consumer name](../../concepts/topic#consumer).
